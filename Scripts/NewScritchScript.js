/**
	{
		"api":1,
		"name":"New Scritch Script",
		"description":"Returns a basic Scritch script.",
		"author":"tlewis",
		"icon":"quote",
		"tags":"scritch,state,script,debug,new,create"
	}
**/
...
function main(state) {
	try {
        ...
        state.fullText will contain or set the entire string from the Scritch editor, regardless of whether a selection is made or not.
