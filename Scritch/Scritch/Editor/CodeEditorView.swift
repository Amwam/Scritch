...
final class CodeEditorView: NSView {
    ...
    private func setUpController() {
        ...
        controller = TextViewController(
            ...
            configuration: SourceEditorConfiguration(
                appearance: .init(
                    theme: ScritchEditorTheme.theme(for: appearance),
    ...
    /// Apply Scritch's light/dark theme for the given appearance.
    func applyTheme(for appearance: NSAppearance) {
        ...
        configuration.appearance.theme = ScritchEditorTheme.theme(for: appearance)
