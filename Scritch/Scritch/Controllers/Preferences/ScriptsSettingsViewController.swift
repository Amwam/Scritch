...
class ScriptsSettingsViewController: NSViewController {
    ...
    @IBAction func didClickDefaultLocation(_ sender: Any) {
        let alert = NSAlert()
        alert.messageText = "The default Scritch folder does not exist. Would you like to create it?"
        alert.informativeText = "The folder will be created at ~/Documents/Scritch."
    ...
    @IBAction func didClickHelpButton(_ sender: Any) {
        ...
        guard let url = URL(string: "https://github.com/Amwam/Scritch/blob/main/Scritch/Documentation/CustomScripts.md") else {
