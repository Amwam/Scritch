...
However, most modules are not compatible with Scritch. Luckily any script
that can be in a browser can work with Scritch!

## Crafting Your Script

First write your script like any normal Scritch Script
...
Scritch is not a browser. That means you need to add a window var. Just add this line
